/*
    https://unity.com/how-to/automated-tests-unity-test-framework#testing-fall-damage

    This script will determine if the player character is in a falling state. If the ground is hit once in a falling state, then the character's health is reduced by 10%.
*/
